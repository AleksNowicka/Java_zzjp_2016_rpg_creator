...
import com.politechnikalodzka.rpgcreator.picture.BuffAndDrawPictures;
...
public class CharacterCreationFrame extends JFrame implements FrameSetter {
    ...
    public CharacterCreationFrame(String title, ManagePictures mP) {
        super(title);
    ...
    public void setupComponents() {
        ...
        for (Picture p : mP.getPictrueToDraw()) {
            JPanel obrazPanel = new BuffAndDrawPictures(p);
            add(obrazPanel);
        }
